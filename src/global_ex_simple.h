...
extern PolarGrid *DivergenceVelocity, *TAURR, *TAUPP, *TAURP, *TAURR2, *TAUPP2, *TAURP2, *Qplus, *Qcoola, *Diag0, *Opacity, *Opacityr, *Fluxr, *Fluxt, *Tdr, *Diag1, *Diag2, *Diag3, *Diag4, *Diag5;
extern boolean LogGrid;
extern boolean OverridesOutputdir;
extern char NewOutputdir[1024];
extern real TUNIT, EUNIT, TEUNIT, MOUNIT, sigma, xgconstcgs;
extern real rc, ttot, dmfal;
extern real AccRate, AccRate2, AccOut, Acc, Accz;
extern real MC, Mdisk, Lstar, Lacc, taueff;
extern int  Iout;
extern int  IFOUTBURST;

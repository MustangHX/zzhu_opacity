...
real SigmaMed[MAX1D], SigmaInf[MAX1D], MassTaper,SigmaMed1[MAX1D];
real EnergyMed[MAX1D], QplusMed[MAX1D], CoolingTimeMed[MAX1D],EnergyMed1[MAX1D];
...
PolarGrid *DivergenceVelocity, *TAURR, *TAUPP, *TAURP, *Qplus, *Qcoola, *Opacity;
boolean LogGrid;
boolean OverridesOutputdir;
char NewOutputdir[1024];
real TUNIT, EUNIT, TEUNIT, MOUNIT, sigma, xgconstcgs;
real MC,Lstar;

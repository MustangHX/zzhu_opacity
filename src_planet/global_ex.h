...
extern real SigmaMed[MAX1D], SigmaInf[MAX1D], MassTaper,SigmaMed1[MAX1D];
extern real EnergyMed[MAX1D], QplusMed[MAX1D], CoolingTimeMed[MAX1D],EnergyMed1[MAX1D];
extern real VthetaMed[MAX1D],VradMed[MAX1D];
extern real OpacMed[MAX1D];
...
extern PolarGrid *DivergenceVelocity, *TAURR, *TAUPP, *TAURP, *Qplus, *Qcoola, *Opacity;

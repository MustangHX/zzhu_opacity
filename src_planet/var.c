...
InitVariables()
{   
  var("COOLMETHOD", &COOLMETHOD, INT, NO, "1");
  var("SUBCOOL", &SUBCOOL, INT, NO, "0");
  //var("OPACITY",&OPACITY,REAL,NO,"10.0");

  var("DT", &DT, REAL, YES, "1.");
  var("DRTRAN", &DRTRAN, REAL, YES, "1.");
  var("RTRAN", &RTRAN, REAL, YES, "1.");
  var("RATIOTRAN", &RATIOTRAN, REAL, YES, "1.");
  var("VISCOSITYRATIO", &VISCOSITYRATIO, REAL, YES, "1.");
  ...
  var("OUTERVR", &OUTERVR, REAL, NO, "0.0");
  var("INNERVR", &INNERVR, REAL, NO, "0.0");
